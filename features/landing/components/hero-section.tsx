      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center max-w-4xl px-6 mt-10 z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1]">
            ...
            <span className="font-cursive text-[1.3em] font-normal mx-2 text-zinc-500 dark:text-zinc-400">with</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D27D2D] via-[#8B4513] to-[#2D211B] dark:from-[#FDBA74] dark:via-[#FBBF24] dark:to-[#A7F3D0]">Vegaspace</span>
          </h1>

          <p
            className="text-lg md:text-xl mb-10 max-w-2xl leading-relaxed transition-colors"
            style={{ color: isDark ? "#C7C7C7" : "#555555" }}
          >
        ...
        <div className="relative w-full max-w-5xl mt-24 px-6 z-10">
          <div
            className="w-full aspect-[16/9] rounded-2xl border overflow-hidden relative transition-colors duration-500 backdrop-blur-3xl"
            style={{
              backgroundColor: isDark ? "rgba(36, 36, 36, 0.4)" : "transparent",
              borderColor: isDark ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.08)",
              boxShadow: isDark
                ? "inset 0 1px 1px rgba(255,255,255,0.15), 0 25px 50px -12px rgba(0,0,0,0.5)"
                : "inset 0 1px 1px rgba(255,255,255,0.3), 0 25px 50px -12px rgba(0,0,0,0.1)"
            }}
          >
          ...
          <div
            ...
            style={{ backgroundColor: isDark ? "rgba(216,234,215,0.2)" : "rgba(255,255,255,0.5)" }}
          />
        </div>
      </section>
    </>
